...
**a. 获得参数amount** update方法中的参数amount需要从params中解析，取的是参数据4..36字节。那么，params是何方神圣？它其实是你在make_tx时传入的`--code "aa91543e0000000000000000000000000000000000000500"`值（详见下文的构造交易），聪明的你，相信很清楚地知道4..36字节表示的是什么！
